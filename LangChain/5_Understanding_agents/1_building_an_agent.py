...
from prompts.base_agent_template import base_agent_template, base_agent_template_w_memory
from tools import MobyDuckSearch, InternetTool


chat_gpt_api = ChatOpenAI(
    temperature=0, model="gpt-3.5-turbo-1106", openai_api_key="OPENAI_API_KEY"
)
